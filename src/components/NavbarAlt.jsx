    ...
    <nav>
      ...
      >
        <div className="px-5 max-w-7xl mx-auto top-0">
          <div
            className={`${navBar || openMobile ? "lg:h-24" : "lg:h-28"} relative flex h-20 align-middle justify-between transition-all`}
            id="navbar"
          >
              ...
              <div className="hidden lg:flex 2xl:justify-end w-full text-2xl">
                <ul className="flex justify-between align-middle w-11/12 gap-5 items-center">
                  {navbarLinks.map((item, index) => (
                    <li
                      key={index}
                      className={`${isActive(item, pathname) ? "decoration-transparent underline font-normal" : "font-thin"} pt-5 uppercase tracking-widest relative group last:no-underline last:px-0`}
